    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/10">
      ...
      <main className="container mx-auto px-6 py-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-2 text-center">ASL Recognition</h2>
          <p className="text-muted-foreground text-center mb-8">
            Position your hand in front of the camera to recognize ASL letters
          </p>
              ...
              <Card className="p-6 bg-gradient-card border-2">
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  ...
                  <li className="flex gap-2">
                    ...
                    <span>Position your hand clearly in frame</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-primary">•</span>
                    <span>Keep hand steady for accurate recognition</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-accent">•</span>
                    <span>AI processing happens in your browser</span>
                  </li>
                </ul>
              </Card>
            </div>
